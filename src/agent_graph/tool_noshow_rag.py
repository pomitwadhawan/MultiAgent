...
class NoShowRAGTool:
    """
    A tool for retrieving relevant no show informataion using a Retrieval-Augmented Generation (RAG) approach with vector embeddings.
...
@tool
def lookup_noshow(query: str) -> str:
